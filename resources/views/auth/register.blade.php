                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label id="alamat" class="col-md-4 control-label">Alamat</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label id="no_telp" class="col-md-4 control-label">No. Telphone</label>
                            <div class="col-md-6">
                                <input id="no_telp" type="text" class="form-control" name="no_telp" value="{{ old('no_telp') }}" required>

                                @if ($errors->has('no_telp'))
                                <span class="help-block">
                                <strong>Nomor sudah terdaftar sebelumnya.</strong>
                                </span>
                                @endif             
                            </div>
                        </div>
